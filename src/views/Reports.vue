  ...
  <div class="space-y-5">
    ...
    <template v-else-if="mode === 'monthly' && monthlyData">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div class="card-elevated p-4 rounded-none bg-indigo-100 dark:bg-indigo-500/10">
          <div class="text-xs text-indigo-700 dark:text-indigo-300 mb-1">Budget</div>
          <div class="text-xl font-semibold text-indigo-800 dark:text-indigo-200">{{ fmt(totalBudget) }}</div>
        ...
        <div class="card-elevated p-4 rounded-none bg-tomato-100 dark:bg-tomato-500/10">
          <div class="text-xs text-tomato-700 dark:text-tomato-300 mb-1">Spent</div>
          <div class="text-xl font-semibold" :class="totalSpent > totalBudget ? 'text-tomato-700' : 'text-tomato-800 dark:text-tomato-200'">{{ fmt(totalSpent) }}</div>
        ...
        <div class="card-elevated p-4 rounded-none bg-kangkong-100 dark:bg-kangkong-500/10">
          <div class="text-xs text-kangkong-700 dark:text-kangkong-300 mb-1">Remaining</div>
          <div class="text-xl font-semibold" :class="totalBudget - totalSpent >= 0 ? 'text-kangkong-700 dark:text-kangkong-200' : 'text-tomato-700'">{{ fmt(totalBudget - totalSpent) }}</div>
          <div class="text-[10px] text-kangkong-700 dark:text-kangkong-300 mt-1">
    ...
    <template v-else-if="mode === 'yearly' && yearlyData">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div class="card-elevated p-4 rounded-none bg-kangkong-100 dark:bg-kangkong-500/10">
          <div class="text-xs text-kangkong-700 dark:text-kangkong-300 mb-1">Total Income</div>
          <div class="text-xl font-semibold text-kangkong-800 dark:text-kangkong-200">{{ fmt(totalIncome) }}</div>
        </div>
        <div class="card-elevated p-4 rounded-none bg-tomato-100 dark:bg-tomato-500/10">
          <div class="text-xs text-tomato-700 dark:text-tomato-300 mb-1">Total Expenses</div>
          <div class="text-xl font-semibold text-tomato-800 dark:text-tomato-200">{{ fmt(totalExpense) }}</div>
        </div>
        <div class="card-elevated p-4 rounded-none bg-purple-100 dark:bg-purple-500/10">
          <div class="text-xs text-purple-700 dark:text-purple-300 mb-1">Savings</div>
          <div class="text-xl font-semibold" :class="totalNet >= 0 ? 'text-purple-800 dark:text-purple-200' : 'text-tomato-700'">{{ totalNet >= 0 ? '+' : '-' }}{{ fmt(totalNet) }}</div>
        </div>
        <div class="card-elevated p-4 rounded-none bg-indigo-100 dark:bg-indigo-500/10">
          <div class="text-xs text-indigo-700 dark:text-indigo-300 mb-1">Savings Rate</div>
          <div class="text-xl font-semibold text-indigo-800 dark:text-indigo-200">{{ savingsRate.toFixed(1) }}%</div>
        </div>
      </div>
