...
<template>
  <div class="flex h-screen bg-[#fbfcfa]">
    ...
    <router-link
      :to="fabLink"
      class="fixed bottom-6 right-6 w-12 h-12 bg-kangkong-600 hover:bg-kangkong-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all z-50 opacity-50 hover:opacity-100"
      title="Add Record"
    >
